...
rather than an automation. Copy it alongside the workflows and edit the mapping; the reasoning
survives the rename.
...
The other two files in `docs/agents/` are generated by `/setup-matt-pocock-skills`; run it rather
than copying them.
